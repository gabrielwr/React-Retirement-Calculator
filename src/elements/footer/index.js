  ...
  return (
    <div
      ...
      links={
        <ul>
          ...
          <a href="http://linkedin.com/in/gabrielrowe">
            <i
              alt="LinkedIn Logo"
              className="fa fa-linkedin-square fa-2x icon"
              aria-hidden="true"></i>
          </a>
          <a href="https://github.com/gabrielwr">
            <i
              alt="GitHub Logo"
              className="fa fa-github fa-2x space-button icon"
              aria-hidden="true"></i>
          </a>
          <a href="https://gabrielwr.github.io/">
            <i
              alt="Portfolio Site"
              className="fa fa-file-pdf-o fa-2x space-button icon"
              aria-hidden="true"></i>
          </a>
        </ul>
      }>
      ...
      <p className="white-text">
        It's a fun little side project that is still very much a work in
        progress!
      </p>
    </div>
  );
