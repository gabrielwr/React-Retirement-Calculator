...
/* Font Family */
export const FONT_FAMILY_LIGHT = 'HelveticaNeue-Light, Helvetica Neue Light, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif';
export const FONT_FAMILY_MEDIUM = 'HelveticaNeue-Medium, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif';
